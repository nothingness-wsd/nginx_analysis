...
ngx_http_autoindex_handler(ngx_http_request_t *r)
{
	...
	dprintf(trace_file_fd, "function:\t" "ngx_http_autoindex_handler\n\n");
...
{
	dprintf(trace_file_fd, "FILE=%s:LINE=%d\n" , __FILE__, __LINE__);
	dprintf(trace_file_fd, "function:\t" "ngx_http_autoindex_create_loc_conf\n\n");
...
{
	dprintf(trace_file_fd, "FILE=%s:LINE=%d\n" , __FILE__, __LINE__);
	dprintf(trace_file_fd, "function:\t" "ngx_http_autoindex_init\n\n");

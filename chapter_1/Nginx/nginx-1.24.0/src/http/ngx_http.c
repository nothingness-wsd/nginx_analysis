...
{
	dprintf(trace_file_fd, "FILE=%s:LINE=%d\n" , __FILE__, __LINE__);
	dprintf(trace_file_fd, "function:\t" "ngx_http_init_phase_handlers\n\n");
    ...
    for (i = 0; i < NGX_HTTP_LOG_PHASE; i++) {
        ...
        case NGX_HTTP_SERVER_REWRITE_PHASE:
        	dprintf(trace_file_fd, "FILE=%s:LINE=%d\n" , __FILE__, __LINE__);
        	dprintf(trace_file_fd, "case NGX_HTTP_SERVER_REWRITE_PHASE:\n\n");
        ...
        case NGX_HTTP_FIND_CONFIG_PHASE:
			dprintf(trace_file_fd, "FILE=%s:LINE=%d\n" , __FILE__, __LINE__);
        	dprintf(trace_file_fd, "case NGX_HTTP_FIND_CONFIG_PHASE:\n\n");
        ...
        case NGX_HTTP_REWRITE_PHASE:
			dprintf(trace_file_fd, "FILE=%s:LINE=%d\n" , __FILE__, __LINE__);
        	dprintf(trace_file_fd, "case NGX_HTTP_REWRITE_PHASE:\n\n");
        ...
        case NGX_HTTP_POST_REWRITE_PHASE:
			dprintf(trace_file_fd, "FILE=%s:LINE=%d\n" , __FILE__, __LINE__);
        	dprintf(trace_file_fd, "case NGX_HTTP_POST_REWRITE_PHASE:\n\n");
        ...
        case NGX_HTTP_ACCESS_PHASE:
			dprintf(trace_file_fd, "FILE=%s:LINE=%d\n" , __FILE__, __LINE__);
        	dprintf(trace_file_fd, "case NGX_HTTP_ACCESS_PHASE:\n\n");
        ...
        case NGX_HTTP_POST_ACCESS_PHASE:
			dprintf(trace_file_fd, "FILE=%s:LINE=%d\n" , __FILE__, __LINE__);
        	dprintf(trace_file_fd, "case NGX_HTTP_POST_ACCESS_PHASE:\n\n");
        ...
        case NGX_HTTP_CONTENT_PHASE:
			dprintf(trace_file_fd, "FILE=%s:LINE=%d\n" , __FILE__, __LINE__);
        	dprintf(trace_file_fd, "case NGX_HTTP_CONTENT_PHASE:\n\n");

    ...
    ngx_atomic_uint_t set)
{
	...
	dprintf(trace_file_fd,"function:\t" "ngx_atomic_cmp_set\n\n");
    ...
    if (*lock == old) 
    {
        *lock = set;
		...
		dprintf(trace_file_fd,"FILE=%s:LINE=%d\n" , __FILE__, __LINE__);
		dprintf(trace_file_fd,"function ngx_atomic_cmp_set:\t" "return 1\n\n");
		
        return 1;
    }

	dprintf(trace_file_fd,"FILE=%s:LINE=%d\n" , __FILE__, __LINE__);
	dprintf(trace_file_fd,"function ngx_atomic_cmp_set:\t" "return 0\n\n");

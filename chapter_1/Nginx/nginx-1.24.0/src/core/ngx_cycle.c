...
ngx_init_cycle(ngx_cycle_t *old_cycle)
{
	...
	dprintf(trace_file_fd, "function:\t" "ngx_init_cycle\n\n");
	...
	dprintf(trace_file_fd, "FILE=%s:LINE=%d\n" , __FILE__, __LINE__);
	dprintf(trace_file_fd, "创建内存池 完成\n" "ngx_create_pool completed\n\n");

	dprintf(trace_file_fd, "FILE=%s:LINE=%d\n" , __FILE__, __LINE__);
	dprintf(trace_file_fd, "分配 ngx_cycle_t 结构体\n\n");
	...
	dprintf(trace_file_fd, "FILE=%s:LINE=%d\n" , __FILE__, __LINE__);
	dprintf(trace_file_fd, "分配 ngx_cycle_t 结构体 完成\n\n");
	...
	dprintf(trace_file_fd, "FILE=%s:LINE=%d\n" , __FILE__, __LINE__);
	dprintf(trace_file_fd, "解析命令行配置指令\n\n");
	...
	dprintf(trace_file_fd, "FILE=%s:LINE=%d\n" , __FILE__, __LINE__);
	dprintf(trace_file_fd, "解析命令行配置指令 完成\n\n");

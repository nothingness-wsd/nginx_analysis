...
ngx_get_full_name(ngx_pool_t *pool, ngx_str_t *prefix, ngx_str_t *name)
{
	...
	dprintf(trace_file_fd,"function:\t" "ngx_get_full_name\n\n");
...
ngx_test_full_name(ngx_str_t *name)
{
    ...
    if (name->data[0] == '/') {
		...
		dprintf(trace_file_fd,"FILE=%s:LINE=%d\n" , __FILE__, __LINE__);
		dprintf(trace_file_fd,"function ngx_test_full_name:\t" "return NGX_OK\n\n");
	
        return NGX_OK;
    }

	dprintf(trace_file_fd,"FILE=%s:LINE=%d\n" , __FILE__, __LINE__);
	dprintf(trace_file_fd,"function ngx_test_full_name:\t" "return NGX_DECLINED\n\n");

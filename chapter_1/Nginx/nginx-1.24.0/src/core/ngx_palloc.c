...
ngx_create_pool(size_t size, ngx_log_t *log)
{
	...
	dprintf(trace_file_fd,"function:\t" "ngx_create_pool\n\n");
    ...
    dprintf(trace_file_fd,"FILE=%s:LINE=%d\n" , __FILE__, __LINE__);
    dprintf(trace_file_fd,"NGX_MAX_ALLOC_FROM_POOL=%ld\n\n", NGX_MAX_ALLOC_FROM_POOL);
	...
	dprintf(trace_file_fd,"FILE=%s:LINE=%d\n" , __FILE__, __LINE__);
	dprintf(trace_file_fd,"function ngx_create_pool:\t" "retun\n\n");
...
{
	dprintf(trace_file_fd, "FILE=%s:LINE=%d\n" , __FILE__, __LINE__);
	dprintf(trace_file_fd, "function:\t" "ngx_palloc\n\n");
...
ngx_palloc_block(ngx_pool_t *pool, size_t size)
{
    ...
    for (p = pool->current; p->d.next; p = p->d.next) {
        if (p->d.failed++ > 4) {
        	...
        	dprintf(trace_file_fd, "FILE=%s:LINE=%d\n" , __FILE__, __LINE__);
        	dprintf(trace_file_fd, "p->d.faile%ld\n\n", p->d.failed);
	...
	dprintf(trace_file_fd, "FILE=%s:LINE=%d\n" , __FILE__, __LINE__);
	dprintf(trace_file_fd, "function %s:\t" "", __func__);
